...
import (
	...
	v1beta1 "sigs.k8s.io/about-api/pkg/generated/listers/core/v1beta1"
)
...
type ClusterPropertyInformer interface {
	...
	Lister() v1beta1.ClusterPropertyLister
}
...
func (f *clusterPropertyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiv1beta1.ClusterProperty{}, f.defaultInformer)
}

func (f *clusterPropertyInformer) Lister() v1beta1.ClusterPropertyLister {
	return v1beta1.NewClusterPropertyLister(f.Informer().GetIndexer())
}
