...
import (
	...
	aboutapiapiv1beta1 "sigs.k8s.io/about-api/api/v1beta1"
	...
	apiv1beta1 "sigs.k8s.io/about-api/pkg/generated/listers/api/v1beta1"
)
...
type ClusterPropertyInformer interface {
	...
	Lister() apiv1beta1.ClusterPropertyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AboutV1beta1().ClusterProperties().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AboutV1beta1().ClusterProperties().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AboutV1beta1().ClusterProperties().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AboutV1beta1().ClusterProperties().Watch(ctx, options)
			},
		},
		&aboutapiapiv1beta1.ClusterProperty{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterPropertyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aboutapiapiv1beta1.ClusterProperty{}, f.defaultInformer)
}

func (f *clusterPropertyInformer) Lister() apiv1beta1.ClusterPropertyLister {
	return apiv1beta1.NewClusterPropertyLister(f.Informer().GetIndexer())
}
