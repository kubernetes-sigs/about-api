...
import (
	...
	pkgapisv1beta1 "sigs.k8s.io/about-api/pkg/apis/v1beta1"
	...
	apisv1beta1 "sigs.k8s.io/about-api/pkg/generated/listers/apis/v1beta1"
)
...
type ClusterPropertyInformer interface {
	...
	Lister() apisv1beta1.ClusterPropertyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AboutV1beta1().ClusterProperties().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AboutV1beta1().ClusterProperties().Watch(context.TODO(), options)
			},
		},
		&pkgapisv1beta1.ClusterProperty{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterPropertyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pkgapisv1beta1.ClusterProperty{}, f.defaultInformer)
}

func (f *clusterPropertyInformer) Lister() apisv1beta1.ClusterPropertyLister {
	return apisv1beta1.NewClusterPropertyLister(f.Informer().GetIndexer())
}
